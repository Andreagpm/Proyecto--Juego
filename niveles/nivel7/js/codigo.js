function validarDatos() {
  ...
  if(primero.value === ""){
	...
	if(primero.value == "g" && segundo.value == "e" && tercero.value == "s" && cuarto.value == "t" && quinto.value == "o"){
		alert("CORRECTO!");
    ...
    document.getElementById("parrafoerrores").value = suma;
		...
		document.getElementById("tercero").value = "s";
...
function restarMonedas() {
	if(inputmonedas.value <= 4){
  	...
  	res = parseInt(num4)-parseInt(num5);
   	document.getElementById("inputmonedas").value = res;
		document.getElementById("primero").value = "g";
